...
namespace cmk
{
	...
	: cmk.ITextViewerFoldingStrategy
	{
		...
		{
			if( MANGER == null || DOCUMENT == null ) return;
		...
		public List<NewFolding> CreateNewFoldings( TextDocument DOCUMENT, out int FIRST_ERROR_OFFSET )
		{
			...
			var started     = new Stack<int>();    // indexes of foldings that haven't beem closed
