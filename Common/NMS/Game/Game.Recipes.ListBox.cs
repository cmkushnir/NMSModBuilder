...
namespace cmk.NMS.Game.Recipes
{
	...
	: cmk.ListBox
	{
		public static bool BigIcons = true;
		...
		public ListBox() : base()
		{
			...
			recipe_border_factory.SetValue(Border.PaddingProperty, new Thickness(4, 4, BigIcons ? 12 : 8, 4));
			recipe_border_factory.SetValue(Border.MarginProperty,  new Thickness(1));
			if( BigIcons ) recipe_border_factory.SetValue(Border.CornerRadiusProperty, new CornerRadius(24));
			else           recipe_border_factory.SetValue(Border.CornerRadiusProperty, new CornerRadius(16));
			...
			recipe_grid_factory.AppendChild(FrameworkElementFactory.CreateColumnAuto("Amount"));  // result amountn
			...
			recipe_grid_factory.AppendChild(FrameworkElementFactory.CreateColumnStar());          // time, recipe id

			var result_icon_factory   = FrameworkElementFactory.CreateImage  (0, 0, BigIcons ? "ResultData.Icon48" : "ResultData.Icon32");
			...
			var recipe_name_factory   = FrameworkElementFactory.CreateTextBox(1, 2, Brushes.DarkBlue, FontWeights.Normal, "Name");
			var recipe_nameid_factory = FrameworkElementFactory.CreateTextBox(1, 3, Brushes.Gray,     FontWeights.Normal, "NameId");
			...
			recipe_grid_factory.AppendChild(recipe_nameid_factory);
