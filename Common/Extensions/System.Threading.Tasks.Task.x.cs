...
namespace cmk
{
	public static partial class _x_
	{
		...
		/// </summary>
		public static void WaitDispatcherFrame( this Task TASK, CancellationToken CANCEL = default )
		{
		...
		/// Wait for TASK to complete while still pumping messages for thread.
		/// </summary>
		public static T WaitDispatcherFrame<T>( this Task<T> TASK, CancellationToken CANCEL = default )
		{
			var nested = new DispatcherFrame();
